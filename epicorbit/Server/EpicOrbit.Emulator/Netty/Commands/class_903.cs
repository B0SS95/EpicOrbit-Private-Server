...
namespace EpicOrbit.Emulator.Netty.Commands {
    ...
    public class class_903 : ICommand {

        // UIWindowSettingsRequest
        // UIWindowSettingsCommand

        public short ID { get; set; } = 14121;
        public List<UIWindowSettingModule> var_3080;

        public class_903(List<UIWindowSettingModule> param1 = null) {
            if (param1 == null) {
