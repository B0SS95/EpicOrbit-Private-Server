...
namespace EpicOrbit.Emulator.Netty.Commands {
    ...
    public class class_524 : ICommand {

        public short ID { get; set; } = 11997;
        public string var_2819 = "";
        public int var_4506 = 0;
        public List<int> var_24;

        public class_524(string param1 = "", int param2 = 0, List<int> param3 = null) {
        ...
        public void Read(IDataInput param1, ICommandLookup lookup) {
            this.var_2819 = param1.ReadUTF();
            this.var_4506 = param1.ReadInt();
            this.var_4506 = param1.Shift(this.var_4506, 21);
            this.var_24.Clear();
        ...
        protected void method_9(IDataOutput param1) {
            param1.WriteUTF(this.var_2819);
            param1.WriteInt(param1.Shift(this.var_4506, 11));
