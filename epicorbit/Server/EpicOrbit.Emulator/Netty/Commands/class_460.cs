...
namespace EpicOrbit.Emulator.Netty.Commands {
    ...
    public class class_460 : ICommand {

        public short ID { get; set; } = 12066;
        public int userId = 0;
        public int var_1197 = 0;

        public class_460(int param1 = 0, int param2 = 0) {
            this.userId = param1;
        ...
        public void Read(IDataInput param1, ICommandLookup lookup) {
            ...
            this.var_1197 = param1.Shift(this.var_1197, 10);
            param1.ReadShort();
        }
        ...
        protected void method_9(IDataOutput param1) {
            ...
            param1.WriteInt(param1.Shift(this.var_1197, 22));
